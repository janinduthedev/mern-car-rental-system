        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100 overflow-hidden relative">
          <div className="relative z-10 max-w-2xl">
            <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 leading-tight">
              ...
              <span className="text-blue-600">for your next journey.</span>
            </h1>
            <p className="mt-4 text-gray-500 text-lg">
              Choose from our curated selection of high-end vehicles. Simple
              booking, transparent pricing, and 24/7 support.
            </p>
          </div>
